...
Begin VB.Form frmFacEntAlbaranes 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(1).Control(10)=   "imgBuscar(9)"
      Tab(1).Control(11)=   "Label1(24)"
      Tab(1).Control(12)=   "imgBuscar(12)"
      ...
      Tab(1).Control(27)=   "Text1(28)"
      Tab(1).Control(28)=   "Text2(29)"
      Tab(1).Control(29)=   "Text1(29)"
      Tab(1).Control(30)=   "FrameHco"
      Tab(1).Control(31)=   "FrameFacRec"
      Tab(1).Control(32)=   "Text1(39)"
      Tab(1).Control(33)=   "Text1(41)"
      Tab(1).ControlCount=   34
      TabCaption(2)   =   "Datos carga"
      TabPicture(2)   =   "frmFacEntAlbaranes.frx":0044
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "Text1(60)"
      Tab(2).Control(1)=   "chkCarga(3)"
      Tab(2).Control(2)=   "chkCarga(2)"
      Tab(2).Control(3)=   "chkCarga(1)"
      Tab(2).Control(4)=   "Text1(59)"
      Tab(2).Control(5)=   "chkCarga(0)"
      Tab(2).Control(6)=   "Text1(58)"
      Tab(2).Control(7)=   "Text1(57)"
      Tab(2).Control(8)=   "Text1(56)"
      Tab(2).Control(9)=   "Text1(55)"
      Tab(2).Control(10)=   "Text1(54)"
      Tab(2).Control(11)=   "Text1(53)"
      Tab(2).Control(12)=   "Text1(52)"
      Tab(2).Control(13)=   "Text1(51)"
      Tab(2).Control(14)=   "Text1(50)"
      Tab(2).Control(15)=   "Text1(49)"
      Tab(2).Control(16)=   "Text1(48)"
      Tab(2).Control(17)=   "Text1(47)"
      Tab(2).Control(18)=   "Text1(46)"
      Tab(2).Control(19)=   "Text1(45)"
      Tab(2).Control(20)=   "Text1(44)"
      Tab(2).Control(21)=   "Text1(43)"
      Tab(2).Control(22)=   "Label1(74)"
      Tab(2).Control(23)=   "Label1(73)"
      Tab(2).Control(24)=   "Label1(72)"
      Tab(2).Control(25)=   "Label1(71)"
      Tab(2).Control(26)=   "Label1(70)"
      Tab(2).Control(27)=   "Label1(69)"
      Tab(2).Control(28)=   "Label1(68)"
      Tab(2).Control(29)=   "Label1(67)"
      Tab(2).Control(30)=   "Label1(66)"
      Tab(2).Control(31)=   "Label1(65)"
      Tab(2).Control(32)=   "Label1(64)"
      Tab(2).Control(33)=   "Label1(63)"
      Tab(2).Control(34)=   "Label1(62)"
      Tab(2).Control(35)=   "Label1(61)"
      Tab(2).Control(36)=   "Label1(60)"
      Tab(2).Control(37)=   "Label1(59)"
      Tab(2).Control(38)=   "Label1(58)"
      Tab(2).Control(39)=   "Label1(57)"
      Tab(2).Control(40)=   "Label1(53)"
      Tab(2).Control(41)=   "Label1(56)"
      Tab(2).Control(42)=   "Label1(55)"
      Tab(2).Control(43)=   "imgFecha(44)"
      Tab(2).Control(44)=   "Label1(54)"
      Tab(2).Control(45)=   "imgBuscar(13)"
...
Dim SQL As String
    ...
    cad = "SELECT salmac.codartic,nomartic,canstock,sarti6.cantidad,precioUD,codProve from salmac,sartic,sarti6"
    ...
    While Not miRsAux.EOF
        ...
        'sOTCK
            ...
            vCStock.Importe = Round2(CCur(DBLet(miRsAux!precioUD, "N") * vCStock.Cantidad), 2)
            ...
            If Ampliacion = "" Then
                Ampliacion = "Codtipoa='ALS' AND codartic =" & DBSet(miRsAux!codArtic, "T") & " AND 1"
                Ampliacion = DevuelveDesdeBD(conAri, "ampliaci", "slifac", Ampliacion, " 1 ORDER BY fecfactu desc LIMIT 0,1")
            End If
            SQL = SQL & DBSet(miRsAux!codArtic, "T") & ", " & DBSet(miRsAux!NomArtic, "T") & ", " & DBSet(Ampliacion, "T") & ", "
            '           cantidad,                   precioar,        dtoline1, dtoline2,        importel,
            SQL = SQL & DBSet(CInt(vCStock.Cantidad), "N") & "," & DBSet(DBLet(miRsAux!precioUD, "N"), "N", "N") & ", 0,0," & DBSet(DBLet(vCStock.Importe, "N"), "N", "N") & ","
