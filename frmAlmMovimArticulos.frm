        ...
        Case "ALC" 'Albaran de Compra (a Proveedores)
            ...
            Else
                ...
                Else
                    ...
                    Else
                        MsgBox "No se encuentra el documento de proveedor", vbExclamation
...
'Ver todos
    ...
    cadB = ""
    If Not vUsu.TrabajadorB Then
        cadB = " codalmac <> " & vParamAplic.AlmacenB
    Else
        If Me.chkConso.Value = 0 Then cadB = " codalmac = " & vParamAplic.AlmacenB
    End If
...
'    Else
        ...
        If cadB <> "" Then
            If Not vUsu.TrabajadorB Then
                cadB = cadB & " AND smoval.codalmac <> " & vParamAplic.AlmacenB
                cadSeleccion = cadSeleccion & " AND ({smoval.codalmac} <> " & vParamAplic.AlmacenB & ")"
            Else
                If Me.chkConso.Value = 0 Then
                    cadB = cadB & " AND smoval.codalmac = " & vParamAplic.AlmacenB
                    cadSeleccion = cadSeleccion & " AND ({smoval.codalmac} = " & vParamAplic.AlmacenB & ")"
                End If
            End If
            ...
            If Not vUsu.TrabajadorB Then
                If cadB2 <> "" Then cadB2 = cadB & " AND "
                cadB2 = cadB2 & " smoval.codalmac <> " & vParamAplic.AlmacenB
                'If cadSeleccion = "" Then cadSeleccion = cadSeleccion & " AND "
                'cadSeleccion = cadSeleccion & "  ({smoval.codalmac} <> " & vParamAplic.AlmacenB & ")"
            Else
                If Me.chkConso.Value = 0 Then
                    If cadB2 <> "" Then cadB2 = cadB2 & " AND "
                    cadB2 = cadB2 & "  smoval.codalmac = " & vParamAplic.AlmacenB
                    'cadSeleccion = cadSeleccion & " AND ({smoval.codalmac} = " & vParamAplic.AlmacenB & ")"
                End If
            End If
