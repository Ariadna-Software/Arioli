...
Begin VB.Form frmFacSituaciones 
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmFacSituaciones.frx":0010
      Height          =   4725
      Left            =   120
      TabIndex        =   9
      TabStop         =   0   'False
...
Private Sub Form_Load()
    ...
    'Cadena consulta
    CadenaConsulta = "Select codsitua,nomsitua,If(tipositu=1,""Si"",""No"") AS tipositu from ssitua"
    CargaGrid
    CargaCombo
End Sub
...
Dim tots As String
    ...
    '### a mano
    tots = "S|txtAux(0)|T|Situación|900|;S|txtAux(1)|T|Denominación|2700|;S|CboTipoSitu|C|Bloquea|800|;"
