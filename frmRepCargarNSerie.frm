    ...
    Case 4 'Modificar Num Serie (Introducir Valores a Cargar)
        ...
        Else 'NO consecutivos, solo carga 1 nº serie
            If DatosOk(txtAux) Then
                If ActualizarNumSerie(txtAux) Then
    '                TerminaBloquear
...
Dim b As Boolean
    ...
    SQL = "select numserie from tmpnseries where numserie='' AND codusu=" & vUsu.Codigo
...
'Dim cad As String
'    PulsadoSalir = True
'    cad = "Va a salir sin Introducir los Nº de Serie." & vbCrLf & "¿Desea continuar?"
'    If MsgBox(cad, vbYesNo) = vbYes Then Unload Me
'End Sub
...
Dim SQL As String
     ...
     SQL = "select numlinea," & NombreTabla & ".codartic, nomartic," & NombreTabla & ".numserie "
...
Private Function ActualizarNumSerie(nSerie As String) As Boolean
'Actualizar en la tabla temporal tmpnseries el Nº de Serie
Dim SQL As String
On Error GoTo EActualizar
           
    'Insertar en la Tabla Temporal
    SQL = "UPDATE " & NombreTabla & " SET numserie=" & DBSet(nSerie, "T")
