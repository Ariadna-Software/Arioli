...
'    'dICIEMBRE 2015
'    CalculaSemana = DatePart("ww", Fecha, vbMonday, vbFirstJan1)
'    If CalculaSemana = 53 Then
'        'Si el 31 es domingo, se queda como esta. Es semana 53. Si no pasa a ser semana 1
'        If Weekday("31/12/" & Year(Fecha), vbMonday) < 7 Then CalculaSemana = 1
'    End If
