...
Dim NumReg As Byte
    ...
    BloquearCmb Combo1, b Or Modo = 0
...
Private Sub CargaCombo()
    ...
    miRsAux.Open "SELECT tipfamia , desctipfamia FROM stipfamia ORDER BY tipfamia", Conn, adOpenForwardOnly, adLockPessimistic, adCmdText
    
    
    
    While Not miRsAux.EOF
        NumRegElim = miRsAux!tipfamia
        Combo1.AddItem miRsAux!desctipfamia
