...
Dim Mostrar_sunilin As Boolean
    ...
    '------------------------------------------------
    Mostrar_sunilin = False
    If vParamAplic.Produccion Then
        Mostrar_sunilin = True
    Else
        If vParamAplic.EsAVAB Then Mostrar_sunilin = True
    End If
    
    DataGrid2.visible = Mostrar_sunilin
    Label1.visible = Mostrar_sunilin
    Me.Toolbar1.Buttons(9).visible = Mostrar_sunilin
    If Mostrar_sunilin Then
