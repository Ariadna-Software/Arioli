...
Begin VB.Form frmOliTarifaOferHco 
   BorderStyle     =   3  'Fixed Dialog
   ClientHeight    =   8280
   ClientLeft      =   45
   ClientTop       =   735
   ClientWidth     =   12660
   Icon            =   "frmOliTarifaOferHco.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   8280
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmOliTarifaOferHco.frx":000C
      ...
      TabPicture(1)   =   "frmOliTarifaOferHco.frx":0028
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "DataGrid2"
      Tab(1).Control(0).Enabled=   0   'False
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "Observaciones"
      TabPicture(2)   =   "frmOliTarifaOferHco.frx":0044
      ...
      Begin MSDataGridLib.DataGrid DataGrid1 
         Bindings        =   "frmOliTarifaOferHco.frx":0060
         Height          =   5280
         Left            =   120
         TabIndex        =   37
         Top             =   360
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   10
         TabIndex        =   44
         Tag             =   "Fecha fin|F|N|||olitarifaofertah|fecelim|dd/mm/yyyy|N|"
         Top             =   360
         Width           =   1185
      End
      Begin VB.Frame FrameTarifa 
         ...
         Begin VB.TextBox Text1 
            ...
            Left            =   240
            TabIndex        =   30
            Tag             =   "Tarifa|N|S|||olitarifaofertah|tarifa|||"
            Text            =   "Text1 7"
            Top             =   240
            Width           =   1245
         End
      ...
      Begin VB.Frame FrameCliente 
         ...
         Begin VB.TextBox Text1 
            ...
            Left            =   120
            TabIndex        =   3
            Tag             =   "Cliente|N|S|||olitarifaofertah|codclien|||"
            Text            =   "Text1 7"
            Top             =   240
            Width           =   1245
         End
         ...
         Begin VB.Image imgCuentas 
            ...
            Index           =   0
            Left            =   840
            Picture         =   "frmOliTarifaOferHco.frx":0075
            Tag             =   "-1"
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   10
         TabIndex        =   2
         Tag             =   "Fecha fin|F|N|||olitarifaofertah|fechafin|dd/mm/yyyy|N|"
         Top             =   360
         Width           =   1185
      End
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   10
         TabIndex        =   1
         Tag             =   "Fecha inicio|F|N|||olitarifaofertah|fechaini|dd/mm/yyyy|N|"
         Top             =   360
         Width           =   1155
      End
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   7
         TabIndex        =   0
         Tag             =   "Codigo|N|S|0||olitarifaofertah|codigo|0000000|S|"
         Text            =   "Text1 7"
         Top             =   360
         Width           =   1125
      End
      Begin VB.Image imgFecha 
         ...
         Index           =   2
         Left            =   4440
         Picture         =   "frmOliTarifaOferHco.frx":0177
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   1
         Left            =   3120
         Picture         =   "frmOliTarifaOferHco.frx":0202
         ToolTipText     =   "Buscar fecha"
         Top             =   120
         Width           =   240
      End
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   0
         Left            =   2040
         Picture         =   "frmOliTarifaOferHco.frx":028D
         ToolTipText     =   "Buscar fecha"
         Top             =   120
         Width           =   240
      End
   ...
   End
End
Attribute VB_Name = "frmOliTarifaOferHco"
...
'
'    Cad = "----------------------------------" & vbCrLf & vbCrLf
'    Cad = Cad & "Va a eliminar la tarifa - oferta:"
...
Private Sub Form_Load()
    ...
    ' .Buttons(12).Image = 21    'Cerrar orden produccion
        ...
        .Buttons(14).Image = 18 'Imprimir Pedido
...
Private Sub EnFuncionTarifa()
    Me.FrameCliente.visible = Not EsTarifa2
    Me.FrameTarifa.visible = EsTarifa2
    ...
    If EmprAVAB > 0 Then   'Si no hay empresa AVAB ni lo ponemos
        If Not EsTarifa2 And (Not vParamAplic.EsAVAB) Then
    ...
    Caption = "HISTORICO Mto tarifas " & NombreTabla
...
Dim cadB As String
    ...
    cadB = cadB & " (olitarifaofertah.codigo  "
    If EsTarifa2 Then
        cadB = cadB & " < "
    Else
        cadB = cadB & " > "
...
Dim b As Boolean
    ...
    Me.Toolbar1.Buttons(btnAnyadir).visible = False
    Me.Toolbar1.Buttons(btnAnyadir + 1).visible = False
    Me.Toolbar1.Buttons(btnAnyadir + 2).visible = False
    
    
    
    Me.Toolbar1.Buttons(10).visible = False
    Me.Toolbar1.Buttons(11).visible = False
...
'                End If '=10
        Case 14
             ...
             If Data1.Recordset.EOF Then
                MsgBox "Seleccione una tarifa-TO", vbExclamation
                Exit Sub
            End If
...
Dim SQL As String
    ...
    SQL = "select olitarifaofertalin2h.codartic,nomartic,costereal,costesimul from olitarifaofertalin2h,sartic "
    SQL = SQL & " where olitarifaofertalin2h.codartic=sartic.codartic AND codigo = "
    If enlaza Then
        SQL = SQL & Val(Text1(0).Text)
    Else
        SQL = SQL & "-1"
    End If
    If enlaza Then SQL = SQL & " AND olitarifaofertalin2h.fecelim= " & DBSet(Text1(6).Text, "F")
...
Private Function Traspasar() As Boolean
Dim b As Boolean
Dim SQL As String
    ...
    On Error GoTo FinEliminar
        ...
        SQL = "INSERT INTO olitarifaoferta(" & TituloLinea & ") SELECT " & TituloLinea & " from olitarifaofertah where codigo =" & Text1(0).Text
        SQL = SQL & " AND fecelim= " & DBSet(Text1(6).Text, "F")
        Conn.Execute SQL
        
        TituloLinea = "codigo,codartic,pivu,pivl,coste1,coste2,coste3,coste4,coste5,margen,pfvu,pfvl"
        SQL = "INSERT INTO olitarifaofertalin(" & TituloLinea & ") SELECT " & TituloLinea & " from olitarifaofertalinh where codigo =" & Text1(0).Text
        SQL = SQL & " AND fecelim= " & DBSet(Text1(6).Text, "F")
        Conn.Execute SQL
        
        TituloLinea = "codigo,codartic,costereal,costesimul"
        SQL = "INSERT INTO olitarifaofertalin2(" & TituloLinea & ") SELECT " & TituloLinea & " from olitarifaofertalin2h where codigo =" & Text1(0).Text
        SQL = SQL & " AND fecelim= " & DBSet(Text1(6).Text, "F")
        Conn.Execute SQL

        
        Conn.Execute "Delete from olitarifaofertalin2h where codigo =" & Text1(0).Text & " AND fecelim= " & DBSet(Text1(6).Text, "F")
        Conn.Execute "Delete from olitarifaofertalinh where codigo =" & Text1(0).Text & " AND fecelim= " & DBSet(Text1(6).Text, "F")
        Conn.Execute "Delete from olitarifaofertah where codigo =" & Text1(0).Text & " AND fecelim= " & DBSet(Text1(6).Text, "F")
        b = True
FinEliminar:
...
Dim SQL As String
    ...
    SQL = SQL & " AND " & NombreTabla & ".fecelim= " & DBSet(Text1(6).Text, "F")
    ObtenerWhereCP = SQL
...
Dim SQL As String
    ...
    SQL = SQL & ",pfvu,pfvl,margecom,LitrosUnidad from olitarifaofertalinh,sartic "
    SQL = SQL & " where olitarifaofertalinh.codartic=sartic.codartic AND "
    
    If enlaza Then
        SQL = SQL & Replace(ObtenerWhereCP, NombreTabla, "olitarifaofertalinh")
    Else
        SQL = SQL & " codigo = -1"
    End If
    SQL = SQL & " Order by codigo"  'podriamos poner codartic tb
    MontaSQLCarga = SQL
End Function
...
Private Sub RecuperarTos()
Dim Cad As String
    'Veremos que en olitarifaoferta NO existe una oferta con este codigo
On Error GoTo EEliminar
    TituloLinea = DevuelveDesdeBD(conAri, "codigo", "olitarifaoferta", "codigo", Text1(0).Text, "T")
    If TituloLinea <> "" Then
        MsgBox "Existe una tarifa-oferta con este codigo. Consulte soporte tecnico", vbExclamation
        Exit Sub
    End If
    
    'Ok pues vamos p'alla

    Cad = "----------------------------------" & vbCrLf & vbCrLf
    Cad = Cad & "Va a pasar a recuperar la tarifa - oferta:"
    Cad = Cad & vbCrLf & "Nº:  " & Format(Text1(0).Text, "0000000")
    Cad = Cad & vbCrLf & "Fechas:  " & Format(Text1(1).Text, "dd/mm/yyyy") & " - " & Format(Text1(3).Text, "dd/mm/yyyy")
    Cad = Cad & vbCrLf & "Traspasada:  " & Format(Text1(6).Text, "dd/mm/yyyy")
    If EsTarifa2 Then
        Cad = Cad & vbCrLf & "Tarifa:  " & Text1(4).Text & " - " & Text2(4).Text
    Else
        Cad = Cad & vbCrLf & "Cliente:  " & Text1(2).Text & " - " & Text2(2).Text
    ...
    If MsgBox(Cad, vbQuestion + vbYesNo) = vbYes Then
        ...
        If Traspasar() Then PosicionarDataTrasEliminar
    End If
    Screen.MousePointer = vbDefault
    
EEliminar:
    Screen.MousePointer = vbDefault
    If Err.Number <> 0 Then MuestraError Err.Number, "Recuperar TOs", Err.Description
End Sub
