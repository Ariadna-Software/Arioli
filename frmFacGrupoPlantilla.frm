...
Begin VB.Form frmFacGrupoPlantilla 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   2
      TabIndex        =   0
      Tag             =   "Código Grupo Plantilla|N|N|0|99|sgrupl|codgrupl|00|S|"
      Text            =   "Dat"
      Top             =   5040
      Width           =   800
   End
...
Dim anc As Single
    ...
    'Obtenemos la siguiente numero de código de Plantilla
...
Private Sub cmdAceptar_GotFocus()
    If Modo = 3 Then
        If txtAux(0).Text = "" Then
            PonerFoco txtAux(0)
            MsgBox "El campo código de Grupo Plantilla no puede ser vacio", , "Error Insertando..."
        End If
    End If
End Sub
...
Private Sub Form_Load()
    ...
    With Me.Toolbar1
        ...
        .Buttons(10).Image = 15  'Botón Salir
    End With
...
Dim tots As String
    ...
    tots = "S|txtAux(0)|T|Grupo|700|;S|txtAux(1)|T|Denominación|2900|;"
