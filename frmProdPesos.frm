...
Begin VB.Form frmProdPesos 
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmProdPesos.frx":000C
      Height          =   5655
      Left            =   120
      TabIndex        =   8
      TabStop         =   0   'False
   ...
   End
End
Attribute VB_Name = "frmProdPesos"
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    CadenaConsulta = "spartidas.codartic=sartic.codartic and id"
    FormatoCod = "numlote"
    CadenaConsulta = DevuelveDesdeBD(conAri, "nomartic", "spartidas,sartic", CadenaConsulta, Campos, "N", FormatoCod)
    Label1(0).Caption = CadenaConsulta
    Label1(1).Caption = FormatoCod
...
Dim b As Boolean
    ...
    If Opcion = 0 Then
        'Pesos materia auxiliar
        CadenaConsulta = "select secuencial,peso from spartidaspesos where idpartida =" & Campos
    ...
    'Nombre producto
    I = 0
        DataGrid1.Columns(I).Caption = "Secuencia"
        DataGrid1.Columns(I).Width = 1000
        DataGrid1.Columns(I).NumberFormat = FormatoCod
    
    'Leemos del vector en 2
    I = 1
        DataGrid1.Columns(I).Caption = "Peso"
        DataGrid1.Columns(I).Width = 3430
