...
Dim cad As String
    ...
    If vParamAplic.QUE_EMPRESA = 4 Then
        If AlbaranEnEntradaOliva Then Exit Sub
    End If
...
Dim b As Boolean
    ...
    If cArt.FactorConversion < 1 Then
         ...
         If cDEP.LeerDatos(CInt(DBLet(Data2.Recordset!Deposito, "N")), False) Then
             If Not cDEP.QuitarAsignacionDeposito2(0, vCStock.Fechamov & " " & Format(Now, "hh:mm:ss"), -cDEP.Kilos) Then MsgBox "Consulte soporte tecnico", vbExclamation
         End If
         Set cDEP = Nothing
    End If
...
Dim CambiarIVA As Boolean
    ...
    FacturaB = False
    If Me.chkPresu.Value Then FacturaB = True
    ...
    If vFactu.CalcularDatosFactura2(cadWhere, NombreTabla, NomTablaLineas, CambiarIVA, FacturaB) Then
...
Dim InsertarEnDeposito As Boolean
    ...
    If ModificaLineas = 1 Then
        ...
        If Text2(19).visible Then
            ...
            If Not cDEP.InsertarEnDeposito2(0, Text1(1).Text & " " & Format(Now, "hh:mm:ss"), "") Then MsgBox "Error grave. Consulte soporte técnico", vbExclamation
            Set cDEP = Nothing
        End If
    ...
    Else
        ...
        If EliminarLoteAnterior Then
            ...
            Set cDEP = New cDeposito
            If cDEP.LeerDatos(CInt(DBLet(Data2.Recordset!Deposito, "N")), False) Then
                If Not cDEP.QuitarAsignacionDeposito2(0, cLot.HoraMov, cDEP.Kilos) Then MsgBox "Eliminando datos en depósito.Consulte soporte tecnico", vbExclamation
            End If
            Set cDEP = Nothing
...
Dim cP As cPartidas
    ...
    Set cP = New cPartidas
    While Not R.EOF
        If cP.LeerDesdeAlbaran(R!codArtic, R!codAlmac, DBLet(R!numlotes, "T"), R!NumAlbar, R!codProve) Then Co.Add CStr(cP.idPartida)
        R.MoveNext
    Wend
    R.Close
    Set R = Nothing
...
Private Function AlbaranEnEntradaOliva() As Boolean
    AlbaranEnEntradaOliva = False
    cadList = ObtenerWhereCP(False)
    cadList = Replace(cadList, "scaalp.", "") & " AND 1"
    cadList = DevuelveDesdeBD(conAri, "id", "vallalmazaraprocesoalb", cadList, "1")
    If cadList <> "" Then
        cadList = "Albaran procedente de la entrada de oliva. No se puede modificar"
        MsgBox cadList, vbExclamation
        cadList = ""
        AlbaranEnEntradaOliva = True
    End If
End Function
