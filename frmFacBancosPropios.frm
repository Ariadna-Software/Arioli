...
Dim devuelve As String
    ...
    Select Case Index
         ...
         Case 12, 13, 19 'DC, numero cta
            
            
            
            If Index = 19 Then
                Me.Text1(19).Text = UCase(Me.Text1(19).Text)
                If Me.Text1(19).Text <> "" Then IBAN_Correcto Me.Text1(19).Text
            Else
                FormateaCampo Text1(Index)
            End If
            If Index = 13 Or Index = 19 Then
                
                devuelve = Text1(10).Text & Text1(11).Text & Text1(12).Text & Text1(13).Text
                If Len(devuelve) = 20 Then
                    'OK. Calculamos el IBAN
                    If Text1(19).Text = "" Then
                        'NO ha puesto IBAN
                        If DevuelveIBAN2("ES", devuelve, devuelve) Then Text1(19).Text = "ES" & devuelve
                    Else
                        CadenaConsulta = CStr(Mid(Text1(19).Text, 1, 2))
                        If DevuelveIBAN2(CadenaConsulta, devuelve, devuelve) Then
                            If Mid(Text1(19).Text, 3) <> devuelve Then
