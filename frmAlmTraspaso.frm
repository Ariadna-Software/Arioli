...
Begin VB.Form frmAlmTraspaso 
   ...
   Begin VB.Image imgBuscar 
      ...
      Index           =   1
      Left            =   1500
      Picture         =   "frmAlmTraspaso.frx":0129
   ...
   Begin VB.Image imgBuscar 
      ...
      Index           =   0
      Left            =   1500
      Picture         =   "frmAlmTraspaso.frx":022B
      ToolTipText     =   "Buscar almacen"
      Top             =   1000
      Width           =   240
   End
   Begin VB.Image imgFecha 
      ...
      Index           =   0
      Left            =   3045
      Picture         =   "frmAlmTraspaso.frx":032D
...
On Error GoTo EInsertarCab
    ...
    SQL = "SELECT codtrasp,fechatra,almaorig,almadest,codtraba,observa1 from scatra "
