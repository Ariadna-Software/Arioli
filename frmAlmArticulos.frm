...
Begin VB.Form frmAlmArticulos 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(3).Control(0)=   "Label2(4)"
      Tab(3).Control(0).Enabled=   0   'False
      Tab(3).Control(1)=   "Label2(5)"
      Tab(3).Control(1).Enabled=   0   'False
      Tab(3).Control(2)=   "data5"
      Tab(3).Control(2).Enabled=   0   'False
      Tab(3).Control(3)=   "DataGrid4"
      Tab(3).Control(3).Enabled=   0   'False
      Tab(3).Control(4)=   "Data3"
      Tab(3).Control(4).Enabled=   0   'False
      Tab(3).Control(5)=   "DataGrid2"
      Tab(3).Control(5).Enabled=   0   'False
      Tab(3).Control(6)=   "txtAux(2)"
      Tab(3).Control(6).Enabled=   0   'False
      Tab(3).Control(7)=   "txtAux3(0)"
      Tab(3).Control(7).Enabled=   0   'False
      Tab(3).Control(8)=   "txtAux3(1)"
      Tab(3).Control(8).Enabled=   0   'False
      Tab(3).Control(9)=   "txtAux3(2)"
      Tab(3).Control(9).Enabled=   0   'False
      Tab(3).Control(10)=   "cmdAux2"
      Tab(3).Control(10).Enabled=   0   'False
      Tab(3).Control(11)=   "txtAux3(3)"
   ...
   Begin MSComctlLib.Toolbar Toolbar1 
      ...
      BeginProperty Buttons {66833FE8-8583-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Button13 {66833FEA-8583-11D1-B16A-00C0F0283628} 
            Object.ToolTipText     =   "Pack articulos"
         EndProperty
   ...
   Begin VB.Menu mnMantenimientos 
      ...
      Begin VB.Menu mnMtoInstalaciones 
         ...
         Shortcut        =   ^I
      End
      Begin VB.Menu mnMtoPackArticulos 
         Caption         =   "&Pack articulos"
         Shortcut        =   ^J
      End
   End
End
...
'    ancIni = 200
    ...
    Case 8
        Me.SSTab1.Tab = 3
        lblIndicador.Caption = "INSERTAR ART-PACK"
        NumF = SugerirCodigoSiguienteStr("sarti6", "numlinea", vWhere)
    End Select
    cmdAceptar.Tag = NumF
...
Dim I As Integer
    ...
    Case 8
        Me.lblIndicador.Caption = "modificar PACK"
        Me.SSTab1.Tab = 3
        txtAux3(0).Text = DataGrid4.Columns(1).Text
        txtAux3(1).Text = DataGrid4.Columns(2).Text
        txtAux3(2).Text = DataGrid4.Columns(3).Text
        txtAux3(3).Text = DataGrid4.Columns(4).Text
    ...
    Case 5
        ...
        Text3(2).Text = Data4.Recordset!nomalmac
        PonerFoco Text3(1)
...
Error2:
    Screen.MousePointer = vbDefault
    If Err.Number <> 0 Then MuestraError Err.Number, "Eliminar articulo pack", Err.Description
End Sub
...
ErrorInstala:
    MuestraError Err.Number, "PACK", Err.Description
    Screen.MousePointer = vbDefault
End Sub
...
Private Sub Form_Load()
    ...
    btnAnyadir = 6
    btnPrimero = 20 'Posicion del Boton Primero en la toolbar (+ 3 siguientes)
    With Me.Toolbar1
        ...
        .Buttons(13).Image = 38 'Instalaciones
    ...
    FrameLitrosUd.visible = True  ' vParamAplic.Descriptores
    
    SSTab1.TabCaption(3) = "Control instalación" & IIf(vParamAplic.PackVtaARticulo, " / PACK", "")
    
    
    
    
    Toolbar1.Buttons(13).Enabled = vParamAplic.PackVtaARticulo
    mnMtoPackArticulos.Enabled = vParamAplic.PackVtaARticulo
    If Not vParamAplic.PackVtaARticulo Then Label2(5).ForeColor = &HC0C0C0
    ...
    If Not vParamAplic.EsAVAB Then
        ...
        If vParamAplic.QUE_EMPRESA < 1 Then
            b = True
        Else
            If vParamAplic.QUE_EMPRESA = 4 Then b = True
        End If
    End If
    ...
    If CadenaDevuelta <> "" Then
        ...
        Else
            ...
            If Modo <> 6 Then
                ...
                If Modo = 8 Then
                    'PACK
                     txtAux3(0).Text = RecuperaValor(CadenaDevuelta, 1)
                     txtAux3(1).Text = RecuperaValor(CadenaDevuelta, 2)
                Else
...
Private Sub mnMtoPackArticulos_Click()
    'mnMtoPackArticulos
    BotonPack
End Sub
...
Dim EsInstal As Boolean
    ...
    If vParamAplic.PackVtaARticulo Then
        EsInstal = b
    Else
        EsInstal = False
    End If
    Toolbar1.Buttons(13).Enabled = EsInstal
    mnMtoPackArticulos.Enabled = EsInstal
...
Private Sub Toolbar1_ButtonClick(ByVal Button As MSComctlLib.Button)
    Select Case Button.Index
        ...
        Case 13
            mnMtoPackArticulos_Click
        
        Case 17 'Imprimir Listado de Articulos
            BotonImprimir
        Case 18 'Salir
            mnSalir_Click
...
Dim CadenaSarti4 As String
    ...
    If Not vParamAplic.EsAVAB And vEmpresa.codempre = EmprMorales Then
        b = True
        If vParamAplic.QUE_EMPRESA = 4 Then b = False
    End If
...
Private Function InsertarModificarPACK() As Boolean
Dim SQL As String
Dim I As Integer

On Error GoTo EInsertarModificarInstalacion
    InsertarModificarPACK = False
    SQL = ""
    For I = 0 To 3
        txtAux3(I).Text = Trim(txtAux3(I).Text)
        If txtAux3(I).Text = "" Then SQL = SQL & vbCrLf & RecuperaValor("Articulo|Art. erroneo|Cantidad|precioUD|", I + 1)
    Next
    If SQL <> "" Then
        MsgBox "Campos incorrectos: " & SQL, vbExclamation
        Exit Function
    End If
    
    If ModificaLineas = 1 Then 'INSERTAR
        SQL = "INSERT INTO sarti6  (codartic ,numlinea,codarti1,cantidad,precioUD) VALUES ("
        SQL = SQL & DBSet(Text1(0).Text, "T") & ", "
        SQL = SQL & cmdAceptar.Tag & ", " & DBSet(txtAux3(0).Text, "T") & ","
        SQL = SQL & DBSet(txtAux3(2).Text, "N") & "," & DBSet(txtAux3(3).Text, "N") & ") "
    ElseIf ModificaLineas = 2 Then 'MODIFICAR
        SQL = "UPDATE sarti6 Set codarti1 = " & DBSet(txtAux3(0).Text, "T")
...
Dim SQL As String
    ...
    ElseIf vDataGrid.Name = "DataGrid4" Then
        ...
        tots = "N||||0|;S|txtAux3(0)|T|Codigo|1400|;S|cmdAux2|B||0|;S|txtAux3(1)|T|Desc. Artículo|3900|;S|txtAux3(2)|T|Cantidad|800|;S|txtAux3(3)|T|Precio Ud|1000|;"
        'El factor de conversion. NO lo muestro pero el datarecordset lo tiene data2!factorconversion
        'tots = tots & "N||||0|;"
        arregla tots, DataGrid4, Me
        DataGrid4.Columns(4).Alignment = dbgRight
        DataGrid4.Columns(4).NumberFormat = FormatoPrecio
...
Dim SQL As String
    ...
    ElseIf Opcion = 5 Then 'PACK ventas
    
    
        SQL = "SELECT sarti6.numlinea,sarti6.codarti1, nomartic ,sarti6.Cantidad,precioUD "
        SQL = SQL & " FROM   sarti6 INNER JOIN sartic ON"
        SQL = SQL & " sarti6.codarti1 = sartic.codArtic WHERE "
        If enlaza Then
            SQL = SQL & " sarti6.codartic=" & DBSet(Text1(0).Text, "T")
        Else
            SQL = SQL & "false"
        End If
        SQL = SQL & " ORDER BY sarti6.numlinea "
...
Dim b As Boolean
    ...
    Case 5
        ...
        txtAux3(0).Height = DataGrid4.RowHeight
        txtAux3(0).visible = b
        txtAux3(0).Top = alto
        txtAux3(1).Height = DataGrid4.RowHeight
        txtAux3(1).visible = b
        txtAux3(1).Top = alto
        txtAux3(2).Height = DataGrid4.RowHeight
        txtAux3(2).visible = b
        txtAux3(2).Top = alto
        txtAux3(3).Height = DataGrid4.RowHeight
        txtAux3(3).visible = b
        txtAux3(3).Top = alto
        cmdAux2.visible = b
        cmdAux2.Top = alto
        cmdAux2.Height = DataGrid4.RowHeight
    End Select
End Sub
...
On Error Resume Next
    ...
    If b Then
        ...
        If Modo = 6 Then
            lblIndicador.Caption = "componentes"
        ElseIf Modo = 7 Then
            lblIndicador.Caption = "instalaciones"
        ElseIf Modo = 8 Then
            lblIndicador.Caption = "PACK"
        Else
            lblIndicador.Caption = "detalle"
        End If
        Me.lblIndicador.Caption = "Lineas " & lblIndicador.Caption
        PonerFocoBtn Me.cmdRegresar
    Else
        Me.lblIndicador.Caption = ""
    End If
...
'            RecalcularPesoArticulo CStr(Data1.Recordset!codArtic), DBLet(Data1.Recordset!UniCajas, "N"), C1, c2
    ...
    If vParamAplic.QUE_EMPRESA = 4 Then
            Aux = DevuelveDesdeBD(conAri, "codartic", "sarti4", "codartic", Text1(0).Text, "T")
            If Aux = "" Then
                Aux = "INSERT INTO sarti4(codartic,pesoneto,pesobruto) VALUES (" & Text1(0).Text & "," & DBSet(Text5(0).Text, "N", "S") & "," & DBSet(Text5(1).Text, "N", "S") & ")"
                EjecutaSQL conAri, Aux, False
            End If
    End If
...
Private Sub TxtAux3_LostFocus(Index As Integer)
    ...
    If Index = 0 Then
        ...
        If txtAux3(Index).Text <> "" Then
            BuscaChekc = DevuelveDesdeBDNew(conAri, "sartic", "nomartic", "codartic", txtAux3(Index).Text, "T")
            If BuscaChekc = "" Then
                MsgBox "No existe el artículo: " & txtAux3(Index).Text, vbExclamation
                PonerFoco txtAux3(Index)
            End If
        End If
        txtAux3(1).Text = BuscaChekc
        
    ElseIf Index = 2 Then
        If txtAux3(Index).Text <> "" Then
            If Not PonerFormatoEntero(txtAux3(Index)) Then
                txtAux3(Index).Text = ""
            Else
    ...
    ElseIf Index = 3 Then
        If txtAux3(Index).Text <> "" Then
            If Not PonerFormatoDecimal(txtAux3(Index), 2) Then
                txtAux3(Index).Text = ""
            Else
                PonerFocoBtn cmdAceptar
            End If
