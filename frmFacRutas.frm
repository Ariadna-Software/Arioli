...
Begin VB.Form frmFacRutas 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   0
      Tag             =   "Código Ruta de Asistencia|N|N|0|999|srutas|codrutas|000|S|"
      Text            =   "Dat"
      Top             =   5040
      Width           =   800
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   25
      TabIndex        =   1
      Tag             =   "Nombre Ruta de Asistencia|T|N|||srutas|nomrutas||N|"
      Text            =   "Dato2"
      Top             =   5040
      Width           =   1395
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmFacRutas.frx":000C
      Height          =   4710
      Left            =   120
      TabIndex        =   8
      TabStop         =   0   'False
...
Dim b As Boolean
    ...
    PonerModoOpcionesMenu 'Activar opciones de menu segón Modo
...
Dim anc As Single
    ...
    txtAux(0).Text = SugerirCodigoSiguienteStr("srutas", "codrutas")
...
Private Sub BotonBuscar()
    CargaGrid "codrutas= -1"  'para vaciar los datos del Grid
...
On Error Resume Next
    ...
    If adodc1.Recordset.RecordCount <= 0 Then
         MsgBox "No hay ningún registro en la tabla srutas", vbInformation
...
On Error GoTo Error2
    ...
    '### a mano
    SQL = "¿Seguro que desea eliminar la Ruta de Asistencia?" & vbCrLf
...
Private Sub Form_Load()
    ...
    'Cadena consulta
    CadenaConsulta = "Select * from srutas"
    CargaGrid
End Sub
...
Private Sub Toolbar1_ButtonClick(ByVal Button As MSComctlLib.Button)
    Select Case Button.Index
        ...
        Case 10 'Imprimir listado de Rutas
            Me.Hide
            AbrirListado (22) 'OpcionListado=22
            Me.Show vbModal
        Case 11 'Salir
            mnSalir_Click
    End Select
...
Dim tots As String
    ...
    Else
        SQL = CadenaConsulta
    End If
    SQL = SQL & " ORDER BY codrutas"
    
    CargaGridGnral DataGrid1, Me.adodc1, SQL, False
    
    '### a mano
    tots = "S|txtAux(0)|T|Rutas|900|;S|txtAux(1)|T|Denominación|2620|;"
