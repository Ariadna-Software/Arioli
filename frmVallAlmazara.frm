...
Begin VB.Form frmVallAlmazara 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   7
         TabIndex        =   0
         Tag             =   "Nº proc almazara|N|S|0||vallalmazaraproceso|id|000000|S|"
         Text            =   "Text1 7"
         Top             =   360
         Width           =   885
      End
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   0
         Left            =   2280
         Picture         =   "frmVallAlmazara.frx":0318
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmVallAlmazara.frx":03A3
      Height          =   3120
      Left            =   120
      TabIndex        =   34
      Top             =   4440
...
Private Sub cmdAux_Click(Index As Integer)
   ...
   ' MandaBusquedaPrevia ""
    ...
    CadenaDesdeOtroForm = ""
    frmListado2.Opcion = 38
    frmListado2.Show vbModal
    If CadenaDesdeOtroForm <> "" Then
        '
        CadenaDesdeOtroForm = Replace(CadenaDesdeOtroForm, "#ID#", Text1(0).Text)
...
Dim cadB As String
    ...
    cadB = ""
    If Me.mnFitro.Checked Then cadB = " fecha >= " & DBSet(vParamAplic.FechaActiva, "F")
...
Dim Indice As Byte
    ...
    If Modo <= 2 Or Modo > 4 Then Exit Sub
...
Private Sub AbrirPartidas()
Dim C As String
    CadenaConsulta = ""
    Set frmL = New frmAlmPartidas
    frmL.DatosADevolverBusqueda = DevuelveDesdeBD(conAri, "artTalco", "vallparam", "1", "1")
    frmL.Show vbModal
    Set frmL = Nothing
    If CadenaConsulta <> "" Then
        'Comprobamos cantidad
   
        Text1(9).Text = RecuperaValor(CadenaConsulta, 1)
        PonerFoco Text1(10)
    End If
...
Dim Devuelve As String
    ...
    CadenaConsulta = ""
    If CDate(Text1(1).Text) < vParamAplic.FechaActiva Then
        CadenaConsulta = "Menor que fecha activa"
    Else
        If CDate(Text1(1).Text) >= vParamAplic.FechaActivaMasUno Then CadenaConsulta = "Mayor fecha maxima permitida"
    End If
        ...
        Case 12, 14, 15
           ...
           End If
            ...
            If Button.Index = 12 Then
                ...
                'rendimiento
                CadenaDesdeOtroForm = "select numalbar,FechaEntrada,codprove,rendimiento  from vallentradacamion,vallentradacamionlineas"
                CadenaDesdeOtroForm = CadenaDesdeOtroForm & " Where vallentradacamionlineas.entrada = vallentradacamion.entrada"
                CadenaDesdeOtroForm = CadenaDesdeOtroForm & " AND rendimiento >0 and (numalbar,FechaEntrada,codprove) IN"
                CadenaDesdeOtroForm = CadenaDesdeOtroForm & " (select numalbar,fechaalb,codprove  FROM  vallalmazaraprocesoalb WHERE id ="
                CadenaDesdeOtroForm = CadenaDesdeOtroForm & Data1.Recordset!ID & ")"
            ...
            Else
                ...
                LlamaImprimirGral "{vallalmazaraproceso.Id}=" & Data1.Recordset!ID, "", 0, "vallMolturacion.rpt", "Parte molturación: " & Format(Data1.Recordset!ID, "0000") & " - " & Data1.Recordset!Fecha
            End If
        Case 20    'Salir
            mnSalir_Click
...
Private Sub CargaCombos()
    ...
    cboAlmazara(0).AddItem "Arbequina"
    cboAlmazara(0).ItemData(cboAlmazara(0).NewIndex) = 2
...
Private Sub InsertarAlbaranesDesdeLiw()
