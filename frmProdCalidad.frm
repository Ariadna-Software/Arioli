...
Begin VB.Form frmProdCalidad 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Calidad orden producción"
   ClientHeight    =   6015
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   15210
   Icon            =   "frmProdCalidad.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6015
   ...
   Begin VB.ComboBox CboCtrLotes 
      Appearance      =   0  'Flat
      Height          =   315
      ItemData        =   "frmProdCalidad.frx":000C
      Left            =   2400
      List            =   "frmProdCalidad.frx":000E
      Style           =   2  'Dropdown List
      TabIndex        =   2
      Tag             =   "O|N|N|||prodCalidad|ocultar||N|"
      Top             =   4920
      Width           =   975
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   0
      Tag             =   "Código|N|N|||prodCalidad|codcalid|00|S|"
      Text            =   "Codigo"
      Top             =   4920
      Width           =   800
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   250
      TabIndex        =   1
      Tag             =   "Descripción|T|N|||prodCalidad|descalid||N|"
      Text            =   "Descripcion"
      Top             =   4920
      Width           =   1395
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmProdCalidad.frx":0010
      Height          =   4710
      Left            =   120
      TabIndex        =   9
      TabStop         =   0   'False
   ...
   End
End
Attribute VB_Name = "frmProdCalidad"
...
Dim anc As Single
    ...
    txtAux(0).Text = SugerirCodigoSiguienteStr("prodCalidad", "codcalid")
    txtAux(1).Text = ""
...
Private Sub BotonVerTodos()
    ...
    If adodc1.Recordset.RecordCount <= 0 Then
         MsgBox "No hay ningún registro en la tabla prodCalidad", vbInformation
...
Dim i As Integer
    ...
    PosicionarCombo Me.CboCtrLotes, CInt(DataGrid1.Columns(2).Text)
...
Dim SQL As String
    ...
    '### a mano
    SQL = "¿Seguro que desea eliminar la linea ?" & vbCrLf
    ...
    If MsgBox(SQL, vbQuestion + vbYesNo) = vbYes Then
        ...
        SQL = "Delete from prodCalidad where codcalid=" & DBSet(adodc1.Recordset!codcalid, "T")
        Conn.Execute SQL
...
Error2:
    Screen.MousePointer = vbDefault
    If Err.Number <> 0 Then MuestraError Err.Number, "Eliminar linea calidad.", Err.Description
End Sub
...
Private Sub Form_Load()
    ...
    'Cadena consulta
    CadenaConsulta = "Select codcalid,descalid,ocultar,If(ocultar=1,""Si"","" "") AS Dctrlotes from prodCalidad"
    CargaGrid
    CargaCombo
End Sub
...
Dim tots As String
    ...
    '### a mano
    tots = "S|txtAux(0)|T|Cod.|800|;S|txtAux(1)|T|Descripción|12200|;N||||0|;S|CboCtrLotes|C|Ocultar|900|;"
...
Private Sub PonFocoEnelUno()
    On Error Resume Next
    Me.txtAux(1).SelStart = Len(Me.txtAux(1).Text)
