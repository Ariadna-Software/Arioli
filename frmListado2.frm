...
Begin VB.Form frmListado2 
   ...
   Begin VB.Frame FrameAlbaranesVall 
      ...
      Begin VB.CheckBox chkVarios 
         Caption         =   "Mostrar por  proveedor(Coop)"
         Height          =   255
         Index           =   2
         Left            =   3360
         TabIndex        =   540
