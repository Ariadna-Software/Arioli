...
Begin VB.Form frmRegistrosManPrev 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Registros Mantenimiento Preventivo"
   ClientHeight    =   6300
   ClientLeft      =   45
   ClientTop       =   630
   ClientWidth     =   12030
   ClipControls    =   0   'False
   Icon            =   "frmRegistrosManPrev.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6300
   ...
   Begin VB.TextBox Text1 
      ...
      Left            =   5640
      TabIndex        =   7
      Tag             =   "Descripcion|T|S|||sregistrosmanprev|Tfno|||"
      Text            =   "Descripcion"
      Top             =   2280
      Width           =   2460
   End
   Begin VB.TextBox Text1 
      ...
      Left            =   1680
      TabIndex        =   6
      Tag             =   "Descripcion|T|S|||sregistrosmanprev|SAT|||"
      Text            =   "Descripcion"
      Top             =   2295
      Width           =   3780
   End
   Begin VB.TextBox Text1 
      ...
      Left            =   240
      TabIndex        =   5
      Tag             =   "Año|N|S|||sregistrosmanprev|anyo|||"
      Text            =   "DiasAviso"
      Top             =   2280
      Width           =   1260
   End
   Begin VB.TextBox Text1 
      ...
      Left            =   5040
      TabIndex        =   4
      Tag             =   "Descripcion|T|S|||sregistrosmanprev|UbicacionPlanta|||"
      Text            =   "Descripcion"
      Top             =   1575
      Width           =   3060
   End
   Begin VB.TextBox Text1 
      ...
      Left            =   240
      TabIndex        =   3
      Tag             =   "Descripcion|T|S|||sregistrosmanprev|NombreTecnico|||"
      Text            =   "Descripcion"
      Top             =   1575
      Width           =   4740
   End
   Begin VB.ComboBox Combo1 
      Height          =   315
      ItemData        =   "frmRegistrosManPrev.frx":000C
      Left            =   4080
      List            =   "frmRegistrosManPrev.frx":001F
      Style           =   2  'Dropdown List
      TabIndex        =   11
      Tag             =   "Cantidad periodo|N|N|||sregistrosmanprev|Perioricidad|||"
      Top             =   3000
      Width           =   1695
   End
   Begin VB.TextBox Text1 
      ...
      Left            =   6000
      TabIndex        =   12
      Tag             =   "rptPropio|T|S|||sregistrosmanprev|ReportPropio|||"
      Text            =   "ReportPropio"
      Top             =   3000
      Width           =   2100
   End
   Begin VB.TextBox Text1 
      ...
      TabIndex        =   13
      Tag             =   "T|T|S|||sregistrosmanprev|TextoAOfertar|||"
      Text            =   "frmRegistrosManPrev.frx":004C
      Top             =   3720
      Width           =   7860
   End
   Begin VB.TextBox Text1 
      ...
      Left            =   6000
      TabIndex        =   2
      Tag             =   "Aviso(dias)|N|S|||sregistrosmanprev|DiasAviso|||"
      Text            =   "DiasAviso"
      Top             =   840
      Width           =   1260
   End
   Begin VB.TextBox Text1 
      ...
      Left            =   1680
      TabIndex        =   9
      Tag             =   "Ultimo doc realizado|F|S|||sregistrosmanprev|UltimoRealizado|dd/mm/yyyy||"
   ...
   Begin VB.TextBox Text1 
      ...
      Left            =   3240
      TabIndex        =   10
      Tag             =   "Cantidad periodo|N|S|||sregistrosmanprev|NumPeriodo|||"
      Text            =   "NumPeriodo"
      Top             =   3000
      Width           =   780
   End
   Begin VB.TextBox Text1 
      ...
      Left            =   240
      TabIndex        =   8
      Tag             =   "1ºFecha|F|N|||sregistrosmanprev|PrimeraFecha|dd/mm/yyyy||"
      Text            =   "PrimeraFecha"
      Top             =   3015
      Width           =   1260
   End
   Begin VB.TextBox Text1 
      ...
      Left            =   1620
      TabIndex        =   1
      Tag             =   "Descripcion|T|N|||sregistrosmanprev|denominacion|||"
      Text            =   "Descripcion"
      Top             =   855
      Width           =   4140
   End
   Begin VB.TextBox Text1 
      ...
      Left            =   240
      TabIndex        =   0
      Tag             =   "idRegistro|T|N|||sregistrosmanprev|codigo||S|"
      Text            =   "idRegistro"
      Top             =   855
      Width           =   1260
   End
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmRegistrosManPrev.frx":005A
      Height          =   4695
      Left            =   8280
      TabIndex        =   17
      Top             =   840
   ...
   End
   Begin VB.Label lblDescCampo 
      Caption         =   "Servicio asistencia técnica"
      Height          =   255
      Index           =   12
      Left            =   1680
      TabIndex        =   35
   ...
   Begin VB.Image imgFecha 
      ...
      Index           =   5
      Left            =   2400
      Picture         =   "frmRegistrosManPrev.frx":006F
      Top             =   2760
      Width           =   240
   End
   Begin VB.Image imgFecha 
      ...
      Index           =   2
      Left            =   960
      Picture         =   "frmRegistrosManPrev.frx":05F9
      Top             =   2760
      Width           =   240
   End
   Begin VB.Label lblDescCampo 
   ...
   End
End
Attribute VB_Name = "frmRegistrosManPrev"
...
Private Sub Form_Load()
    ...
    NombreTabla = "sregistrosmanprev" 'Tabla Precios Especiales de Articulos
    Ordenacion = " ORDER BY codigo"
    CadenaConsulta = "Select * from " & NombreTabla & " WHERE "
    
    
        CadenaConsulta = CadenaConsulta & " codigo= 'DABIZ'" 'No recupera datos
...
Private Sub imgFecha_Click(Index As Integer)
   ...
   If Modo = 2 Or Modo = 0 Or Modo = 5 Then Exit Sub
   Screen.MousePointer = vbHourglass
...
Private Sub Toolbar1_ButtonClick(ByVal Button As MSComctlLib.Button)
    Select Case Button.Index
        ...
        Case 13
            LlamaImprimirGral "", "", 0, "morListMantePrev.rpt", "Listado registros"
            
        Case 14
            If Data1.Recordset.EOF Then Exit Sub
            If Data2.Recordset.EOF Then Exit Sub
            
            CadenaConsulta = "{sregistrosmanprev.codigo}=" & DBSet(Text1(0).Text, "T") & " AND {sregistrosmanprevl.secuencial} = " & Data2.Recordset!secuencial
            
            CadenaDesdeOtroForm = "MorRegistroMan.rpt"
...
Dim tabla As String
    ...
    tabla = "sregistrosmanprevl"
    SQL = "SELECT secuencial,fecha,if(firmado=0,""NO"",""si"") FROM " & tabla
    If enlaza Then
        SQL = SQL & " WHERE sregistrosmanprevl.codigo=" & DBSet(Data1.Recordset!Codigo, "T")
    Else
        SQL = SQL & " WHERE codigo = 'DABIZ'"
    End If
...
On Error GoTo FinEliminar
        ...
        SQL = " WHERE codigo=" & DBSet(Data1.Recordset!Codigo, "T")
        
        'Lineas  sregistrosmanprevl
        Conn.Execute "Delete  from sregistrosmanprevl " & SQL
        
        'Cabeceras sregistrosmanprev
        Conn.Execute "Delete  from sregistrosmanprev " & SQL
...
Dim vWhere As String
    ...
    vWhere = "(codigo=" & DBSet(Text1(0).Text, "T") & ")"
...
Dim Inc As Integer
    ...
    If Accion = 3 Then
        ...
        CadenaDesdeOtroForm = "Delete from sregistrosmanprevl where codigo=" & DBSet(Text1(0).Text, "T") & " AND secuencial =" & Data2.Recordset!secuencial
        If Not EjecutaSQL(conAri, CadenaDesdeOtroForm) Then Exit Sub
        
        'Veo cual es el ultimo ejecutado
        CadenaDesdeOtroForm = DevuelveDesdeBD(conAri, "max(fecha)", "sregistrosmanprevl", "codigo", DevNombreSQL(Text1(0).Text), "T")
        ...
        If Text1(5).Text <> CadenaDesdeOtroForm Then
            ...
            'ha cambiado
            CadenaDesdeOtroForm = "UPDATE sregistrosmanprev SET UltimoRealizado = " & DBSet(CadenaDesdeOtroForm, "F", "S")
            CadenaDesdeOtroForm = CadenaDesdeOtroForm & " WHERE codigo = " & DBSet(Text1(0).Text, "T")
    ...
    Else
        ...
        With frmRegistroL2
            ...
            .InsMod = Not SoloVer
            .Nregistro2 = Data1.Recordset!Codigo
            If Accion = 1 Then
                .linea = 0
            Else
    ...
    If Not SituarData(Data1, "(codigo=" & DBSet(Text1(0).Text, "T") & ")", "") Then
        PonerModo 0
    Else
        'La fecha
